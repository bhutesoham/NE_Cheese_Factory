...
if (fs.existsSync(envPath)) {
  ...
  console.error('  DATABASE_URL=postgresql://postgres:yourpassword@localhost:5432/kaaswinkel\n')
  process.exit(1)
}
...
if (!DB_URL || DB_URL.includes('username:password')) {
  ...
  console.error('Set it like: DATABASE_URL=postgresql://postgres:yourpassword@localhost:5432/kaaswinkel\n')
  process.exit(1)
}
...
try {
  ...
  console.error('Expected: postgresql://username:password@localhost:5432/kaaswinkel')
  console.error('If your password contains special characters like # @ use %23 or %40 instead.\n')
  process.exit(1)
}
